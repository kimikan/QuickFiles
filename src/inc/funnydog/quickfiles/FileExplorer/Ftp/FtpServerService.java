...
import inc.funnydog.quickfiles.FileExplorer.Ftp.server.SessionThread;
import inc.funnydog.quickfiles.FileExplorer.Ftp.server.TcpListener;
...
public class FtpServerService extends Service implements Runnable {
    ...
    static public final String ACTION_STARTED = "inc.funnydog.quickfiles.FileExplorer.Ftp.FTPSERVER_STARTED";
    static public final String ACTION_STOPPED = "inc.funnydog.quickfiles.FileExplorer.Ftp.FTPSERVER_STOPPED";
    static public final String ACTION_FAILEDTOSTART = "inc.funnydog.quickfiles.FileExplorer.Ftp.FTPSERVER_FAILEDTOSTART";

    // RequestStartStopReceiver listens for these actions to start/stop this server
	static public final String ACTION_START_FTPSERVER = "inc.funnydog.quickfiles.FileExplorer.Ftp.ACTION_START_FTPSERVER";
    static public final String ACTION_STOP_FTPSERVER = "inc.funnydog.quickfiles.FileExplorer.Ftp.ACTION_STOP_FTPSERVER";
